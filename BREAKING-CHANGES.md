...
[adding a new required property in request body is breaking](checker/checker_breaking_property_test.go?plain=1#L302)  
...
[changing a request body type is breaking, but adding enum simultaneously is ignored](checker/checker_breaking_property_test.go?plain=1#L152)  
[changing a request property to enum is breaking](checker/checker_breaking_property_test.go?plain=1#L166)  
[changing a required property in response body to optional and also deleting it is breaking](checker/checker_breaking_property_test.go?plain=1#L230)  
[changing a response body to nullable is breaking](checker/checker_breaking_property_test.go?plain=1#L182)  
[changing a response property to nullable is breaking](checker/checker_breaking_property_test.go?plain=1#L198)  
[changing an embedded reponse property to nullable is breaking](checker/checker_breaking_property_test.go?plain=1#L214)  
[changing an existing header param from optional to required is breaking](checker/checker_breaking_test.go?plain=1#L183)  
[changing an existing property in request body to required is breaking](checker/checker_breaking_property_test.go?plain=1#L286)  
...
[changing an existing required property in response body to not-write-only is breaking](checker/checker_breaking_property_test.go?plain=1#L526)  
...
[deleting a required property in request is breaking with warn](checker/checker_breaking_property_test.go?plain=1#L318)  
[deleting a required property in response body is breaking](checker/checker_breaking_property_test.go?plain=1#L366)  
[deleting a required property under AllOf in response body is breaking](checker/checker_breaking_property_test.go?plain=1#L396)  
[deleting a required property within another property in request is breaking with warn](checker/checker_breaking_property_test.go?plain=1#L335)  
...
[adding a new required property in response body is not breaking](checker/checker_breaking_property_test.go?plain=1#L352)  
[adding a new required property under AllOf in response body is not breaking](checker/checker_breaking_property_test.go?plain=1#L382)  
[adding a new required read-only property in request body is not breaking](checker/checker_breaking_property_test.go?plain=1#L436)  
[adding a non-existent required property in request body is not breaking](checker/checker_breaking_property_test.go?plain=1#L244)  
...
[changing an existing property in request body to optional is not breaking](checker/checker_breaking_property_test.go?plain=1#L272)  
...
[changing an existing property in response body to required is not breaking](checker/checker_breaking_property_test.go?plain=1#L258)  
[changing an existing read-only property in request body to required is not breaking](checker/checker_breaking_property_test.go?plain=1#L450)  
...
[changing an existing required property in response body to write-only is not breaking](checker/checker_breaking_property_test.go?plain=1#L512)  
[changing an existing write-only property in response body to optional is not breaking](checker/checker_breaking_property_test.go?plain=1#L498)  
...
[deleting a non-required non-write-only property in response body is not breaking](checker/checker_breaking_property_test.go?plain=1#L481)  
...
[deleting a required write-only property in response body is not breaking](checker/checker_breaking_property_test.go?plain=1#L464)  
