...
[adding a new security component](checker/check-components-security-updated_test.go?plain=1#L53)  
...
[changing security component type](checker/check-components-security-updated_test.go?plain=1#L32)  
...
[removing a new oauth security scope](checker/check-components-security-updated_test.go?plain=1#L112)  
[removing a new security component](checker/check-components-security-updated_test.go?plain=1#L72)  
