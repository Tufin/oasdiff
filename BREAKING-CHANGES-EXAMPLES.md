...
[adding a pattern to a schema is breaking](checker/checker_breaking_test.go?plain=1#L451)  
...
[changing response's body schema type from string to number is breaking](checker/check-request-body-required-value-updated_test.go?plain=1#L11)  
...
[deleting a media-type from response is breaking](checker/checker_breaking_test.go?plain=1#L421)  
...
[removing an existing optional response header is breaking as warn](checker/checker_breaking_test.go?plain=1#L402)  
...
[removing an schema object from components is breaking (optional)](checker/checker_breaking_test.go?plain=1#L584)  
...
[removing/updating a property enum in response is breaking (optional)](checker/checker_breaking_test.go?plain=1#L316)  
[removing/updating a tag is breaking (optional)](checker/checker_breaking_test.go?plain=1#L333)  
[removing/updating an enum in request body is breaking (optional)](checker/checker_breaking_test.go?plain=1#L294)  
[removing/updating an operation id is breaking (optional)](checker/checker_breaking_test.go?plain=1#L282)  
[setting the default value of an optional request parameter is breaking](checker/checker_breaking_test.go?plain=1#L547)  

## Examples of non-breaking changes
[adding a media-type to response is not breaking](checker/checker_not_breaking_test.go?plain=1#L177)  
...
[adding a tag is not breaking with "api-tag-removed" check](checker/checker_not_breaking_test.go?plain=1#L274)  
[adding a tag is not breaking](checker/checker_not_breaking_test.go?plain=1#L259)  
[adding an enum value is not breaking](checker/checker_not_breaking_test.go?plain=1#L75)  
[adding an enum value to request body is not breaking](checker/checker_breaking_property_test.go?plain=1#L138)  
[adding an operation ID is not breaking with "api-operation-id-removed" check](checker/checker_not_breaking_test.go?plain=1#L285)  
[adding an optional request body is not breaking](checker/checker_not_breaking_test.go?plain=1#L30)  
...
[changing a link to operation ID is not breaking](checker/checker_not_breaking_test.go?plain=1#L168)  
...
[changing an existing request body from required to optional is not breaking](checker/checker_not_breaking_test.go?plain=1#L45)  
...
[changing comments is not breaking](checker/checker_not_breaking_test.go?plain=1#L99)  
[changing extensions is not breaking](checker/checker_not_breaking_test.go?plain=1#L87)  
...
[changing operation ID is not breaking](checker/checker_not_breaking_test.go?plain=1#L159)  
...
[changing servers is not breaking](checker/checker_not_breaking_test.go?plain=1#L245)  
...
[deleting a pattern from a schema is not breaking](checker/checker_breaking_test.go?plain=1#L437)  
...
[deleting a tag is not breaking](checker/checker_not_breaking_test.go?plain=1#L63)  
[deleting an operation after sunset date is not breaking](checker/checker_deprecation_test.go?plain=1#L69)  
[deprecating a header is not breaking](checker/checker_not_breaking_test.go?plain=1#L219)  
[deprecating a parameter is not breaking](checker/checker_not_breaking_test.go?plain=1#L206)  
[deprecating a schema is not breaking](checker/checker_not_breaking_test.go?plain=1#L232)  
...
[modifying the default value of a required request parameter is not breaking](checker/checker_breaking_test.go?plain=1#L565)  
[new optional header param is not breaking](checker/checker_not_breaking_test.go?plain=1#L111)  
[new optional property in request header is not breaking](checker/checker_breaking_property_test.go?plain=1#L38)  
[new required response header param is not breaking](checker/checker_not_breaking_test.go?plain=1#L145)  
[no change is not breaking](checker/checker_not_breaking_test.go?plain=1#L25)  
...
[removing an existing response with error status is not breaking](checker/checker_breaking_test.go?plain=1#L386)  
[removing an existing response with unparseable status is not breaking](checker/checker_breaking_test.go?plain=1#L370)  
...
[Adding a new operation id is detected](checker/check-api-operation-id-updated_test.go?plain=1#L61)  
[Adding a new tag is detecteds](checker/check-api-tag-updated_test.go?plain=1#L11)  
[Adding a response non-success status is detected](checker/check-response-status-updated_test.go?plain=1#L38)  
[Adding a success response status is detected](checker/check-response-status-updated_test.go?plain=1#L11)  
[Removing a non-success status is detected](checker/check-response-status-updated_test.go?plain=1#L65)  
[Removing a success status is detected and is breaking](checker/check-response-status-updated_test.go?plain=1#L92)  
[Removing an existing operation id is detected](checker/check-api-operation-id-updated_test.go?plain=1#L11)  
[Removing an existing tag is detected](checker/check-api-tag-updated_test.go?plain=1#L36)  
[Updating an existing operation id is detected](checker/check-api-operation-id-updated_test.go?plain=1#L36)  
[Updating an existing tag is detected](checker/check-api-tag-updated_test.go?plain=1#L62)  
...
[changing an existing header param to optional](checker/checker_not_breaking_test.go?plain=1#L125)  
[deprecating an operation with sunset greater than min](checker/checker_not_breaking_test.go?plain=1#L191)  
