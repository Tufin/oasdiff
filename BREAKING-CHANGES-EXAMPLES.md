...
[changing response's body schema type from integer to number is breaking](checker/checker_breaking_type_changes_test.go?plain=1#L63)  
[changing response's body schema type from number to string is breaking](checker/checker_breaking_type_changes_test.go?plain=1#L29)  
[changing response's body schema type from string to number is breaking](checker/checker_breaking_type_changes_test.go?plain=1#L11)  
[changing response's embedded property schema type from string/none to integer/int32 is breaking](checker/checker_breaking_type_changes_test.go?plain=1#L81)  
...
[changing response's body schema type from number to integer is not breaking](checker/checker_breaking_type_changes_test.go?plain=1#L47)  
