...
[adding 'anyOf' schema to the request body or request body property](checker/check-request-property-any-off-updated_test.go?plain=1#L11)  
[adding 'anyOf' schema to the response body or response body property](checker/check-response-property-any-off-updated_test.go?plain=1#L11)  
...
[removing 'anyOf' schema from the request body or request body property](checker/check-request-property-any-off-updated_test.go?plain=1#L47)  
[removing 'anyOf' schema from the response body or response body property](checker/check-response-property-any-off-updated_test.go?plain=1#L47)  
