...
[adding a media-type to response is not breaking](checker/checker_not_breaking_test.go?plain=1#L181)  
...
[adding a opeartion ID is not breaking with "operation-id-removed" check](checker/checker_not_breaking_test.go?plain=1#L289)  
[adding a tag is not breaking with "api-tag-removed" check](checker/checker_not_breaking_test.go?plain=1#L278)  
[adding a tag is not breaking](checker/checker_not_breaking_test.go?plain=1#L263)  
...
[changing servers is not breaking](checker/checker_not_breaking_test.go?plain=1#L249)  
...
[deprecating a header is not breaking](checker/checker_not_breaking_test.go?plain=1#L223)  
[deprecating a parameter is not breaking](checker/checker_not_breaking_test.go?plain=1#L210)  
[deprecating a schema is not breaking](checker/checker_not_breaking_test.go?plain=1#L236)  
...
[deprecating an operation with sunset greater than min](checker/checker_not_breaking_test.go?plain=1#L195)  
