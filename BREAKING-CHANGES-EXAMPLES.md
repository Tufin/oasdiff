...
[Optional response property became not read-only](checker/check-response-optional-property-write-only-read-only_test.go?plain=1#L82)  
[Optional response property became not write-only](checker/check-response-optional-property-write-only-read-only_test.go?plain=1#L35)  
[Optional response property became read-only](checker/check-response-optional-property-write-only-read-only_test.go?plain=1#L58)  
[Optional response property became write-only](checker/check-response-optional-property-write-only-read-only_test.go?plain=1#L11)  
...
[Required response property became not read-only](checker/check-response-required-property-write-only-read-only_test.go?plain=1#L83)  
[Required response property became not write-only](checker/check-response-required-property-write-only-read-only_test.go?plain=1#L35)  
[Required response property became read-only](checker/check-response-required-property-write-only-read-only_test.go?plain=1#L59)  
[Required response property became write-only](checker/check-response-required-property-write-only-read-only_test.go?plain=1#L11)  
