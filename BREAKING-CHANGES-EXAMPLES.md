...
[adding a new operation id](checker/check-api-operation-id-updated_test.go?plain=1#L65)  
...
[adding a security scope to an API endpoint security](checker/check-api-security-updated_test.go?plain=1#L165)  
...
[removing a new security to the API endpoint](checker/check-api-security-updated_test.go?plain=1#L117)  
...
[removing a security scope from an API endpoint security](checker/check-api-security-updated_test.go?plain=1#L141)  
