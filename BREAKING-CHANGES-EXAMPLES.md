...
[adding 'allOf' subschema to the request body or request body property is breaking](checker/checker_breaking_test.go?plain=1#L695)  
[adding a new required property in request body is breaking](checker/checker_breaking_property_test.go?plain=1#L352)  
[adding a pattern to a schema is breaking for recursive properties](checker/checker_breaking_test.go?plain=1#L476)  
[adding a pattern to a schema is breaking](checker/checker_breaking_test.go?plain=1#L460)  
...
[changing a response property to optional under AllOf, AnyOf or OneOf is breaking](checker/checker_breaking_property_test.go?plain=1#L646)  
...
[changing an existing property in request body anyOf to required is breaking](checker/checker_breaking_property_test.go?plain=1#L614)  
[changing an existing property in request body items to required is breaking](checker/checker_breaking_property_test.go?plain=1#L598)  
...
[changing an existing property under another property in request body to required is breaking](checker/checker_breaking_property_test.go?plain=1#L630)  
[changing an existing request body from optional to required is breaking](checker/checker_breaking_test.go?plain=1#L82)  
[changing an existing required property in response body to not-write-only is breaking](checker/checker_breaking_property_test.go?plain=1#L563)  
[changing an existing response header from required to optional is breaking](checker/checker_breaking_test.go?plain=1#L212)  
...
[deleting a media-type from response is breaking](checker/checker_breaking_test.go?plain=1#L430)  
[deleting a non-required non-write-only property in response body is breaking with warning](checker/checker_breaking_property_test.go?plain=1#L514)  
...
[deleting a required property in response body is breaking](checker/checker_breaking_property_test.go?plain=1#L423)  
[deleting a required property under AllOf in response body is breaking](checker/checker_breaking_property_test.go?plain=1#L453)  
...
[modifying a pattern in a schema is breaking](checker/checker_breaking_test.go?plain=1#L492)  
[modifying a pattern in request parameter is breaking](checker/checker_breaking_test.go?plain=1#L508)  
[modifying the default value of an optional request parameter is breaking](checker/checker_breaking_test.go?plain=1#L538)  
...
[removing 'allOf' subschema from the request body or request body property is breaking with warn](checker/checker_breaking_test.go?plain=1#L717)  
[removing 'anyOf' schema from the request body or request body property is breaking](checker/checker_breaking_test.go?plain=1#L652)  
[removing 'oneOf' schema from the request body or request body property is breaking](checker/checker_breaking_test.go?plain=1#L674)  
[removing a media type from request body is breaking](checker/checker_breaking_test.go?plain=1#L636)  
[removing a success status is breaking](checker/check-response-status-updated_test.go?plain=1#L92)  
[removing an existing optional response header is breaking as warn](checker/checker_breaking_test.go?plain=1#L411)  
[removing an existing required response header is breaking as error](checker/checker_breaking_test.go?plain=1#L228)  
[removing an existing response with non-successful status is breaking (optional)](checker/checker_breaking_test.go?plain=1#L265)  
[removing an existing response with successful status is breaking](checker/checker_breaking_test.go?plain=1#L247)  
[removing an schema object from components is breaking (optional)](checker/checker_breaking_test.go?plain=1#L611)  
[removing the default value of an optional request parameter is breaking](checker/checker_breaking_test.go?plain=1#L574)  
...
[removing/updating a property enum in response is breaking (optional)](checker/checker_breaking_test.go?plain=1#L325)  
[removing/updating a tag is breaking (optional)](checker/checker_breaking_test.go?plain=1#L342)  
[removing/updating an enum in request body is breaking (optional)](checker/checker_breaking_test.go?plain=1#L303)  
[removing/updating an operation id is breaking (optional)](checker/checker_breaking_test.go?plain=1#L283)  
[setting the default value of an optional request parameter is breaking](checker/checker_breaking_test.go?plain=1#L556)  

## Examples of non-breaking changes
[adding a media-type to response is not breaking](checker/checker_not_breaking_test.go?plain=1#L185)  
[adding a new required property in response body is not breaking](checker/checker_breaking_property_test.go?plain=1#L409)  
[adding a new required property under AllOf in response body is not breaking](checker/checker_breaking_property_test.go?plain=1#L439)  
[adding a new required read-only property in request body is not breaking](checker/checker_breaking_property_test.go?plain=1#L469)  
...
[changing an existing read-only property in request body to required is not breaking](checker/checker_breaking_property_test.go?plain=1#L483)  
[changing an existing required property in response body to write-only is not breaking](checker/checker_breaking_property_test.go?plain=1#L549)  
[changing an existing write-only property in response body to optional is not breaking](checker/checker_breaking_property_test.go?plain=1#L535)  
...
[deleting a pattern from a schema is not breaking](checker/checker_breaking_test.go?plain=1#L446)  
[deleting a required write-only property in response body is not breaking](checker/checker_breaking_property_test.go?plain=1#L497)  
...
[modifying a pattern to ".*" in a schema is not breaking](checker/checker_breaking_test.go?plain=1#L524)  
[modifying the default value of a required request parameter is not breaking](checker/checker_breaking_test.go?plain=1#L592)  
...
[removing an existing response with error status is not breaking](checker/checker_breaking_test.go?plain=1#L395)  
[removing an existing response with unparseable status is not breaking](checker/checker_breaking_test.go?plain=1#L379)  
...
[adding 'allOf' subschema to the response body or response body property](checker/check-response-property-all-of-updated_test.go?plain=1#L11)  
...
[adding a new operation id](checker/check-api-operation-id-updated_test.go?plain=1#L63)  
[adding a new optional request property](checker/check-request-property-updated_test.go?plain=1#L67)  
...
[adding a non-success response status](checker/check-response-status-updated_test.go?plain=1#L38)  
...
[adding a required write-only property to response body is detected](checker/check-response-required-property-updated_test.go?plain=1#L61)  
[adding a security scope from an API global security](checker/check-api-security-updated_test.go?plain=1#L69)  
[adding a security scope to an API endpoint security](checker/check-api-security-updated_test.go?plain=1#L161)  
...
[adding an enum value to a response write-only property](checker/check-response-property-enum-value-added_test.go?plain=1#L37)  
[adding an enum value to request parameter](checker/check-request-parameter-enum-value-updated_test.go?plain=1#L35)  
[adding an optional write-only property to a response](checker/check-response-optional-property-updated_test.go?plain=1#L35)  
[adding discriminator to the request body or request body property](checker/check-request-discriminator-updated_test.go?plain=1#L12)  
[adding discriminator to the response body or response property](checker/check-response-discriminator-updated_test.go?plain=1#L12)  
[adding pattern to request parameters](checker/check-request-parameter-pattern-added-or-changed_test.go?plain=1#L36)  
[adding request body default value or request property default value](checker/check-request-property-default-value-changed_test.go?plain=1#L60)  
[adding request parameter default value](checker/check-request-parameters-default-value-changed_test.go?plain=1#L35)  
[adding request property enum values](checker/check-request-property-enum-value-updated_test.go?plain=1#L38)  
[adding request property pattern](checker/check-request-property-pattern-added-or-changed_test.go?plain=1#L37)  
[adding response body default value or response body property default value](checker/check-response-property-default-value-changed_test.go?plain=1#L69)  
[adding response property pattern](checker/check-response-pattern-added-or-changed_test.go?plain=1#L38)  
[adding two new request properties, one required, one optional](checker/check-request-property-updated_test.go?plain=1#L34)  
[changing a response property schema format](checker/check-response-property-type-changed_test.go?plain=1#L61)  
[changing a response property schema type](checker/check-response-property-type-changed_test.go?plain=1#L35)  
...
[changing discriminator mapping in the request body or request body property](checker/check-request-discriminator-updated_test.go?plain=1#L124)  
[changing discriminator mapping in the response body or response property](checker/check-response-discriminator-updated_test.go?plain=1#L126)  
[changing discriminator propertyName in the request body or request body property](checker/check-request-discriminator-updated_test.go?plain=1#L86)  
[changing discriminator propertyName in the response body or response property](checker/check-response-discriminator-updated_test.go?plain=1#L88)  
[changing optional request property to not read-only](checker/check-request-property-write-only-read-only_test.go?plain=1#L89)  
...
[changing optional request property to read-only](checker/check-request-property-write-only-read-only_test.go?plain=1#L63)  
[changing optional request property to write-only](checker/check-request-property-write-only-read-only_test.go?plain=1#L11)  
[changing optional response property to not read-only](checker/check-response-optional-property-write-only-read-only_test.go?plain=1#L91)  
[changing optional response property to not write-only](checker/check-response-optional-property-write-only-read-only_test.go?plain=1#L38)  
[changing optional response property to read-only](checker/check-response-optional-property-write-only-read-only_test.go?plain=1#L64)  
...
[changing optional response write-only property to required](checker/check-response-property-became-required_test.go?plain=1#L34)  
...
[changing request body and property types from object to array](checker/check-request-property-type-changed_test.go?plain=1#L121)  
[changing request body default value](checker/check-request-property-default-value-changed_test.go?plain=1#L11)  
[changing request body to not nullable](checker/check-request-property-became-not-nuallable_test.go?plain=1#L86)  
[changing request body to nullable](checker/check-request-property-became-not-nuallable_test.go?plain=1#L60)  
[changing request body type](checker/check-request-property-type-changed_test.go?plain=1#L11)  
[changing request header parameter format](checker/check-request-parameters-type-changed_test.go?plain=1#L141)  
[changing request header parameter type](checker/check-request-parameters-type-changed_test.go?plain=1#L63)  
...
[changing request path parameter format](checker/check-request-parameters-type-changed_test.go?plain=1#L89)  
[changing request path parameter type](checker/check-request-parameters-type-changed_test.go?plain=1#L11)  
[changing request property default value](checker/check-request-property-default-value-changed_test.go?plain=1#L35)  
[changing request property format](checker/check-request-property-type-changed_test.go?plain=1#L155)  
...
[changing request property to nullable](checker/check-request-property-became-not-nuallable_test.go?plain=1#L35)  
[changing request property type](checker/check-request-property-type-changed_test.go?plain=1#L63)  
[changing request query parameter format](checker/check-request-parameters-type-changed_test.go?plain=1#L115)  
...
[changing required request property to not read-only](checker/check-request-property-write-only-read-only_test.go?plain=1#L193)  
[changing required request property to not write-only](checker/check-request-property-write-only-read-only_test.go?plain=1#L141)  
[changing required request property to read-only](checker/check-request-property-write-only-read-only_test.go?plain=1#L167)  
[changing required request property to write-only](checker/check-request-property-write-only-read-only_test.go?plain=1#L115)  
[changing required response property to not read-only](checker/check-response-required-property-write-only-read-only_test.go?plain=1#L92)  
[changing required response property to not write-only](checker/check-response-required-property-write-only-read-only_test.go?plain=1#L38)  
...
[changing response body default value](checker/check-response-property-default-value-changed_test.go?plain=1#L44)  
...
[changing write-only required response property to optional](checker/check-response-property-became-optional_test.go?plain=1#L34)  
[decreasing max length of request body](checker/check-request-property-max-length-updated_test.go?plain=1#L40)  
[decreasing max length of request property](checker/check-request-property-max-length-updated_test.go?plain=1#L69)  
[decreasing maxItems of request parameters](checker/check-request-parameters-max-items-updated_test.go?plain=1#L35)  
[decreasing maxLength of request parameters](checker/check-request-parameters-max-length-updated_test.go?plain=1#L34)  
...
[decreasing minLength of request body](checker/check-request-property-min-length-updated_test.go?plain=1#L89)  
...
[decreasing request body maximum value](checker/check-request-property-max-updated_test.go?plain=1#L94)  
...
[increasing max length of request property](checker/check-request-property-max-length-updated_test.go?plain=1#L97)  
...
[increasing minLength of request body](checker/check-request-property-min-length-updated_test.go?plain=1#L63)  
[increasing minLength of request property](checker/check-request-property-min-length-updated_test.go?plain=1#L37)  
...
[increasing request body maximum value](checker/check-request-property-max-updated_test.go?plain=1#L65)  
...
[removing 'allOf' subschema from the request body or request body property](checker/check-request-property-all-of-updated_test.go?plain=1#L49)  
[removing 'allOf' subschema from the response body or response body property](checker/check-response-property-all-of-updated_test.go?plain=1#L49)  
[removing 'anyOf' schema from the request body or request body property](checker/check-request-property-any-of-updated_test.go?plain=1#L49)  
[removing 'anyOf' schema from the response body or response body property](checker/check-response-property-any-of-updated_test.go?plain=1#L49)  
[removing 'oneOf' schema from the request body or request body property](checker/check-request-property-one-of-updated_test.go?plain=1#L49)  
[removing 'oneOf' schema from the response body or response body property](checker/check-response-property-one-of-updated_test.go?plain=1#L60)  
...
[removing a new security to the API endpoint](checker/check-api-security-updated_test.go?plain=1#L113)  
[removing a non-success response status](checker/check-response-status-updated_test.go?plain=1#L65)  
[removing a required request property](checker/check-request-property-updated_test.go?plain=1#L91)  
[removing a required write-only property that was required in response body is detected](checker/check-response-required-property-updated_test.go?plain=1#L88)  
[removing a security scope from an API endpoint security](checker/check-api-security-updated_test.go?plain=1#L137)  
...
[removing an existent property that was required in response body is detected](checker/check-response-required-property-updated_test.go?plain=1#L36)  
...
[removing discriminator from the request body or request body property](checker/check-request-discriminator-updated_test.go?plain=1#L49)  
[removing discriminator from the response body or response property](checker/check-response-discriminator-updated_test.go?plain=1#L50)  
[removing media type from request body](checker/check-request-body-mediatype-updated_test.go?plain=1#L35)  
[removing pattern from request parameters](checker/check-request-parameter-pattern-added-or-changed_test.go?plain=1#L60)  
[removing request body default value or request property default value](checker/check-request-property-default-value-changed_test.go?plain=1#L96)  
[removing request parameter default value](checker/check-request-parameters-default-value-changed_test.go?plain=1#L61)  
[removing request property enum values](checker/check-request-property-enum-value-updated_test.go?plain=1#L11)  
[removing request property pattern](checker/check-request-property-pattern-added-or-changed_test.go?plain=1#L61)  
[removing response body default value or response body property default value](checker/check-response-property-default-value-changed_test.go?plain=1#L106)  
[removing response property pattern](checker/check-response-pattern-added-or-changed_test.go?plain=1#L65)  
[updating an existing operation id](checker/check-api-operation-id-updated_test.go?plain=1#L37)  
