...
[adding a pattern to a schema is breaking for recursive properties](checker/checker_breaking_test.go?plain=1#L449)  
...
[changing an existing header param from optional to required is breaking](checker/checker_request_parameter_required_value_updated_test.go?plain=1#L12)  
...
[modifying a pattern in a schema is breaking](checker/checker_breaking_test.go?plain=1#L465)  
[modifying a pattern in request parameter is breaking](checker/checker_breaking_test.go?plain=1#L481)  
[modifying the default value of an optional request parameter is breaking](checker/checker_breaking_test.go?plain=1#L511)  
...
[removing an schema object from components is breaking (optional)](checker/checker_breaking_test.go?plain=1#L566)  
...
[setting the default value of an optional request parameter is breaking](checker/checker_breaking_test.go?plain=1#L529)  
...
[modifying a pattern to ".*" in a schema is not breaking](checker/checker_breaking_test.go?plain=1#L497)  
