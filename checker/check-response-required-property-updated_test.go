...
// // CL: Updating a existent property to required in response body is detected
// TODO: Check if it's covered by another checker
// func TestResponseRequiredPropertyUpdatedToRequired(t *testing.T) {
// 	s1, _ := open("../data/checker/response_required_property_added_base.yaml")
