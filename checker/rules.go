...
func GetAllRules() []BackwardCompatibilityRule {
	return []BackwardCompatibilityRule{
		...
		newBackwardCompatibilityRule(ResponseMediaTypeUpdatedId, ERR, true, ResponseMediaTypeUpdatedCheck),
		...
		newBackwardCompatibilityRule(RequestAllOfModifiedId, WARN, true, UncheckedRequestAllOfWarnCheck),
		// UncheckedResponseAllOfWarnCheck
		newBackwardCompatibilityRule(ResponseAllOfModifiedId, WARN, true, UncheckedResponseAllOfWarnCheck),
