...
// CL: Optional response property became write-only
...
// CL: Optional response property became not write-only
...
// CL: Optional response property became read-only
...
// CL: Optional response property became not read-only
