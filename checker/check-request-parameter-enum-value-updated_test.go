...
func TestRequestParameterEnumValueRemovedCheck(t *testing.T) {
	...
	require.Equal(t, checker.ApiChange{
		...
		Text:        "removed the enum value available for the 'query' request parameter 'status'",
		Level:       checker.ERR,
		Operation:   "GET",
		Path:        "/test",
...
func TestRequestParameterEnumValueAddedCheck(t *testing.T) {
	...
	require.Equal(t, checker.ApiChange{
		...
		Text:        "added the new enum value available for the 'query' request parameter 'status'",
		Level:       checker.INFO,
		Operation:   "GET",
		Path:        "/test",
