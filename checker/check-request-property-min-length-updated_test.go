...
func TestRequestPropertyMinLengthDecreased(t *testing.T) {
	...
	require.Equal(t, checker.ApiChange{
		...
		Text:        "the 'name' request property's maxLength was decreased to '2'",
		Comment:     "",
		Level:       checker.INFO,
		Operation:   "POST",
		Path:        "/products",
...
func TestRequestPropertyMinLengthIncreased(t *testing.T) {
	...
	require.Equal(t, checker.ApiChange{
		...
		Text:        "the 'name' request property's maxLength was increased to '5'",
		Comment:     "",
		Level:       checker.INFO,
		Operation:   "POST",
		Path:        "/products",
...
func TestRequestBodyMinLengthIncreased(t *testing.T) {
	...
	require.Equal(t, checker.ApiChange{
		...
		Text:        "the request's body maxLength was increased to '100'",
		Comment:     "",
		Level:       checker.INFO,
		Operation:   "POST",
		Path:        "/products",
...
func TestRequestBodyMinLengthDecreased(t *testing.T) {
	...
	require.Equal(t, checker.ApiChange{
		...
		Text:        "the request's body maxLength was decreased to '1'",
		Comment:     "",
		Level:       checker.INFO,
		Operation:   "POST",
		Path:        "/products",
