...
// 2023-04-30 11:41:40.601858 +0300 IDT m=+0.002309506
...
var localizations = map[string]string{
	...
	"ru.messages.request-body-became-enum":                                 "request body was restricted to a list of enum values",
	...
	"ru.messages.request-header-property-became-enum":                      "the %s request header's property %s was restricted to a list of enum values",
	"ru.messages.request-header-property-became-required":                  "в заголовке запроса %s поле %s стало обязательным",
	"ru.messages.request-parameter-became-enum":                            "the %s request parameter %s was restricted to a list of enum values",
	...
	"ru.messages.request-property-became-enum":                             "request property %s was restricted to a list of enum values",
