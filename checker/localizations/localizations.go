...
// 2023-07-28 12:57:46.358261 +0100 IST m=+0.004681376
...
var localizations = map[string]string{
	...
	"ru.messages.request-body-min-length-decreased":                        "значение minLength у тела запроса уменьшено до %s",
	...
	"ru.messages.request-property-min-length-increased":                    "значение minLength у поля запроса %s увеличено до %s",
