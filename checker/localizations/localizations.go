...
// 2023-07-28 14:35:07.07033 +0100 IST m=+0.005076168
...
var localizations = map[string]string{
	...
	"en.messages.request-body-min-length-decreased":                        "the request's body maxLength was decreased from %s to %s",
	"en.messages.request-body-min-length-increased":                        "the request's body maxLength was increased from %s to %s",
	...
	"en.messages.request-property-min-length-decreased":                    "the %s request property's maxLength was decreased from %s to %s",
	"en.messages.request-property-min-length-increased":                    "the %s request property's maxLength was increased from %s to %s",
	...
	"ru.messages.request-body-min-length-decreased":                        "максимальная длина тела запроса была уменьшена с %s до %s",
	"ru.messages.request-body-min-length-increased":                        "максимальная длина тела запроса была увеличена с %s до %s",
	...
	"ru.messages.request-property-min-length-decreased":                    "максимальная длина свойства запроса %s была уменьшена с %s до %s",
	"ru.messages.request-property-min-length-increased":                    "максимальная длина свойства запроса %s была увеличена с %s до %s",
