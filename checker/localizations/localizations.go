...
// 2023-07-27 16:29:00.734248 +0100 IST m=+0.005770626
...
var localizations = map[string]string{
	...
	"ru.messages.response-body-discriminator-added":                        "added response discriminator for the response status %s",
	"ru.messages.response-body-discriminator-mapping-added":                "added %s mapping keys to the response discriminator for the response status %s",
	"ru.messages.response-body-discriminator-mapping-changed":              "mapped value for key %s changed from %s to %s from the response discriminator for the response status %s",
	"ru.messages.response-body-discriminator-mapping-deleted":              "removed %s mapping keys from the response discriminator for the response status %s",
	"ru.messages.response-body-discriminator-property-name-changed":        "response discriminator property name changed from %s to %s for the response status %s",
	"ru.messages.response-body-discriminator-removed":                      "removed response discriminator for the response status %s",
	...
	"ru.messages.response-property-discriminator-added":                    "added discriminator to %s response property for the response status %s",
	"ru.messages.response-property-discriminator-mapping-added":            "added %s discriminator mapping keys to the %s response property for the response status %s",
	"ru.messages.response-property-discriminator-mapping-changed":          "mapped value for discriminator key %s changed from %s to %s for %s response property for the response status %s",
	"ru.messages.response-property-discriminator-mapping-deleted":          "removed %s discriminator mapping keys from the %s response property for the response status %s",
	"ru.messages.response-property-discriminator-property-name-changed":    "response discriminator property name changed for %s response property from %s to %s for the response status %s",
	"ru.messages.response-property-discriminator-removed":                  "removed discriminator to %s response property for the response status %s",
