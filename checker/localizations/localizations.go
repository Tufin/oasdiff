...
// 2023-07-27 13:52:57.191234 +0100 IST m=+0.004522710
...
var localizations = map[string]string{
	...
	"en.messages.request-body-max-increased":                               "the request's body max was increased to %s",
	"en.messages.request-body-max-length-decreased":                        "the request's body maxLength was decreased to %s",
	"en.messages.request-body-max-length-increased":                        "the request's body maxLength was increased to %s",
	...
	"en.messages.request-body-min-length-decreased":                        "the request's body maxLength was decreased to %s",
	"en.messages.request-body-min-length-increased":                        "the request's body maxLength was increased to %s",
	...
	"en.messages.request-property-max-increased":                           "the %s request property's max was increased to %s",
	"en.messages.request-property-max-length-decreased":                    "the %s request property's maxLength was decreased to %s",
	"en.messages.request-property-max-length-increased":                    "the %s request property's maxLength was increased to %s",
	...
	"en.messages.request-property-min-length-decreased":                    "the %s request property's maxLength was decreased to %s",
	"en.messages.request-property-min-length-increased":                    "the %s request property's maxLength was increased to %s",
	...
	"ru.messages.request-body-max-increased":                               "значение max у тела запроса увеличено до %s",
	"ru.messages.request-body-max-length-decreased":                        "значение maxLength у тела запроса уменьшено до %s",
	"ru.messages.request-body-max-length-increased":                        "значение maxLength у тела запроса увеличено до %s",
	...
	"ru.messages.request-body-min-decreased":                               "значение min у тела запроса уменьшено до %s",
	"ru.messages.request-body-min-increased":                               "значение min у тела запроса увеличено до %s",
	"ru.messages.request-body-min-items-decreased":                         "значение minItems у тела запроса уменьшено до %s",
	...
	"ru.messages.request-body-min-length-decreased":                        "the request's body maxLength was decreased to %s",
	"ru.messages.request-body-min-length-increased":                        "значение minLength у тела запроса увеличено до %s",
	...
	"ru.messages.request-property-max-increased":                           "значение max у поля запроса %s увеличено до %s",
	"ru.messages.request-property-max-length-decreased":                    "значение maxLength у поля запроса %s уменьшено до %s",
	"ru.messages.request-property-max-length-increased":                    "значение maxLength у поля запроса %s увеличено до %s",
	...
	"ru.messages.request-property-min-decreased":                           "значение min у поля запроса %s уменьшено до %s",
	"ru.messages.request-property-min-increased":                           "у поля запроса %s, увеличено значение min до %s",
	"ru.messages.request-property-min-items-decreased":                     "значение minItems у поля запроса %s уменьшено до %s",
	...
	"ru.messages.request-property-min-length-decreased":                    "the %s request property's maxLength was decreased to %s",
	"ru.messages.request-property-min-length-increased":                    "the %s request property's maxLength was increased to %s",
