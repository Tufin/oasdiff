...
// 2023-08-01 10:05:24.143487 +0100 IST m=+0.005265334
...
var localizations = map[string]string{
	...
	"en.messages.request-body-discriminator-added":                         "added request schema discriminator",
	"en.messages.request-body-discriminator-mapping-added":                 "added %s mapping keys to the request schema discriminator",
	"en.messages.request-body-discriminator-mapping-changed":               "mapped value for key %s changed from %s to %s from the request schema discriminator",
	"en.messages.request-body-discriminator-mapping-deleted":               "removed %s mapping keys from the request schema discriminator",
	"en.messages.request-body-discriminator-property-name-changed":         "request schema discriminator property name changed from %s to %s",
	"en.messages.request-body-discriminator-removed":                       "removed request schema discriminator",
	...
	"en.messages.request-property-discriminator-property-name-changed":     "request schema discriminator property name changed for %s request property from %s to %s",
	"en.messages.request-property-discriminator-removed":                   "removed discriminator to %s request property",
	...
	"en.messages.response-property-discriminator-removed":                  "removed discriminator to %s response property for the response status %s",
  ...
  "ru.messages.request-body-discriminator-added":                         "добавлен дискриминатор схемы запроса",
	"ru.messages.request-body-discriminator-mapping-added":                 "добавлены ключи сопоставления %s в дискриминатор схемы запроса",
	"ru.messages.request-body-discriminator-mapping-changed":               "значение для ключа %s изменено с %s на %s в дискриминаторе схемы запроса",
	"ru.messages.request-body-discriminator-mapping-deleted":               "удалены ключи сопоставления %s из дискриминатора схемы запроса",
	"ru.messages.request-body-discriminator-property-name-changed":         "изменено имя свойства дискриминатора схемы запроса с %s на %s",
	"ru.messages.request-body-discriminator-removed":                       "удален дискриминатор схемы запроса",
	...
	"ru.messages.request-property-discriminator-added":                     "добавлен дискриминатор для свойства запроса %s",
	"ru.messages.request-property-discriminator-mapping-added":             "добавлены ключи дискриминатора %s в свойство запроса %s",
	...
	"ru.messages.request-property-discriminator-mapping-deleted":           "удалены ключи дискриминатора %s из свойства запроса %s",
	"ru.messages.request-property-discriminator-property-name-changed":     "изменено имя свойства дискриминатора схемы запроса для свойства запроса %s с %s на %s",
	"ru.messages.request-property-discriminator-removed":                   "удален дискриминатор для свойства запроса %s",
	...
	"ru.messages.response-body-discriminator-mapping-added":                "добавлены ключи сопоставления %s в дискриминатор ответа для статуса ответа %s",
	...
	"ru.messages.response-body-discriminator-property-name-changed":        "изменено имя свойства дискриминатора ответа с %s на %s для статуса ответа %s",
	...
	"ru.messages.response-property-discriminator-added":                    "добавлен дискриминатор для свойства ответа %s для статуса ответа %s",
	"ru.messages.response-property-discriminator-mapping-added":            "добавлены ключи дискриминатора %s в свойство ответа %s для статуса ответа %s",
	...
	"ru.messages.response-property-discriminator-mapping-deleted":          "удалены ключи дискриминатора %s из свойства ответа %s для статуса ответа %s",
	"ru.messages.response-property-discriminator-property-name-changed":    "изменено имя свойства дискриминатора ответа для свойства ответа %s с %s на %s для статуса ответа %s",
	"ru.messages.response-property-discriminator-removed":                  "удален дискриминатор для свойства ответа %s для статуса ответа %s",
