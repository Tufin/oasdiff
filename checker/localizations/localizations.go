...
// 2023-03-30 17:51:57.501938 +0100 IST m=+0.001948501
...
var localizations = map[string]string{
	...
	"en.messages.response-property-enum-value-removed":                     "response property %s enum value removed %s",
	...
	"ru.messages.response-property-enum-value-removed":                     "значение перечисления свойства ответа %s удалено %s",
