...
// 2023-07-14 10:28:50.459504 +0100 IST m=+0.004850543
...
var localizations = map[string]string{
	...
	"en.messages.response-write-only-property-enum-value-added":            "added the new '%s' enum value the %s response write-only property for the response status %s",
