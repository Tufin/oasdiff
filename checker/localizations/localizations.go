...
// 2022-11-25 15:00:45.432893326 +0300 MSK m=+0.002138051
...
var localizations = map[string]string{
	...
	"ru.messages.response-property-min-items-unset":                        "у поля ответа %s улаоено значение minItems, предыдущее значение - %s, для ответа со статусом %s",
