...
// 2023-07-25 17:18:49.502875 +0100 IST m=+0.004228418
...
var localizations = map[string]string{
	...
	"en.messages.request-parameter-enum-value-added":                       "added the new enum value %s for the %s request parameter %s",
