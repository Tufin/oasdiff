...
// 2023-07-18 14:00:23.861833 +0100 IST m=+0.004863709
...
var localizations = map[string]string{
	...
	"en.messages.response-property-default-value-changed":                  "the %s response property default value changed from %s to %s for the status %s",
	...
	"en.messages.response-property-pattern-added":                          "the %s response property pattern %s was added for the status %s",
	"en.messages.response-property-pattern-changed":                        "the %s response property pattern was changed from %s to %s for the status %s",
	"en.messages.response-property-pattern-removed":                        "the %s response property pattern %s was removed for the status %s",
