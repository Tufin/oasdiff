...
// 2023-07-14 15:42:52.9913 +0100 IST m=+0.004755334
...
var localizations = map[string]string{
	...
	"en.messages.response-media-default-value-changed":                     "the response property %s default value changed from %s to %s for the status %s",
