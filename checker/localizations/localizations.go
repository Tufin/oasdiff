...
// 2023-06-27 14:01:22.447487 +0100 IST m=+0.004246126
...
var localizations = map[string]string{
	...
	"en.messages.api-global-security-added":                                "the security %s was added to the API",
	"en.messages.api-global-security-removed":                              "the security %s was removed from the API",
	...
	"en.messages.api-global-security-updated":                              "the security %s was updated from %s to %s",
	...
	"en.messages.api-security-added":                                       "the endpoint security %s was added to the API",
	"en.messages.api-security-component-added":                             "the component security schema %s was added",
	"en.messages.api-security-component-oauth-scope-added":                 "the component security schema %s oauth scope %s was added",
	"en.messages.api-security-component-oauth-scope-changed":               "the component security schema %s oauth scope %s was updated from %s to %s",
	"en.messages.api-security-component-oauth-scope-removed":               "the component security schema %s oauth scope %s was removed",
	"en.messages.api-security-component-oauth-url-changed":                 "the component security schema %s oauth url changed from %s to %s",
	"en.messages.api-security-component-removed":                           "the component security schema %s was removed",
	"en.messages.api-security-component-type-changed":                      "the component security schema %s type changed from %s to %s",
	"en.messages.api-security-removed":                                     "the endpoint security %s was removed from the API",
	...
	"en.messages.api-security-updated":                                     "the endpoint security %s was updated from %s to %s",
	...
	"ru.messages.api-global-security-added":                                "к API была добавлена глобальная безопасность %s",
	"ru.messages.api-global-security-removed":                              "из API была удалена глобальная безопасность %s",
	...
	"ru.messages.api-global-security-updated":                              "в глобальной безопасности %s произошло обновление с %s на %s",
	...
	"ru.messages.api-security-added":                                       "к API была добавлена безопасность %s",
	"ru.messages.api-security-component-added":                             "была добавлена компонента схемы безопасности %s",
	"ru.messages.api-security-component-oauth-scope-added":                 "к компоненте схемы безопасности %s была добавлена область OAuth %s",
	"ru.messages.api-security-component-oauth-scope-changed":               "в компоненте схемы безопасности %s область OAuth %s была обновлена с %s на %s",
	"ru.messages.api-security-component-oauth-scope-removed":               "из компоненты схемы безопасности %s была удалена область OAuth %s",
	"ru.messages.api-security-component-oauth-url-changed":                 "URL OAuth в компоненте схемы безопасности %s был изменен с %s на %s",
	"ru.messages.api-security-component-removed":                           "была удалена компонента схемы безопасности %s",
	"ru.messages.api-security-component-type-changed":                      "тип компонента схемы безопасности %s был изменен с %s на %s",
	"ru.messages.api-security-removed":                                     "из API была удалена безопасность %s",
	...
	"ru.messages.api-security-updated":                                     "в безопасности эндпоинта %s произошло обновление с %s на %s",
