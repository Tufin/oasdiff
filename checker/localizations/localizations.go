...
// 2023-07-04 11:44:58.434901 +0100 IST m=+0.001750126
...
var localizations = map[string]string{
	...
	"en.messages.total-changes":                                            "Total API changes (%d):\n    [info (%d)| error (%d)| warning (%d)]\n",
	...
	"ru.messages.total-changes":                                            "Всего изменений в API (%d):\n [информация (%d)| ошибка (%d)| предупреждение (%d)]\n",
