...
// 2023-07-14 16:58:04.971572 +0100 IST m=+0.004281709
...
var localizations = map[string]string{
	...
	"en.messages.response-property-default-value-changed":                  "the response property %s default value changed from %s to %s for the status %s",
	...
	"en.messages.response-property-pattern-added":                          "the response property %s pattern %s was added for the status %s",
	"en.messages.response-property-pattern-changed":                        "the response property %s pattern changed from %s to %s for the status %s",
	"en.messages.response-property-pattern-removed":                        "the response property %s pattern %s was removed for the status %s",
