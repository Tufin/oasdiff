...
[deleting an endpoint before sunset is breaking](diff/deprecation_test.go?plain=1#L19)  
[deleting an endpoint without sunset is breaking](diff/deprecation_test.go?plain=1#L36)  
...
[deprecating an endpoint with a deprecation policy and sunset date before required deprecation period is breaking](diff/deprecation_test.go?plain=1#L112)  
[deprecating an endpoint with a deprecation policy but without specifying sunset date is breaking](diff/deprecation_test.go?plain=1#L70)  
...
[deleting an endpoint after sunset is not breaking](diff/deprecation_test.go?plain=1#L53)  
...
[deprecating an endpoint with a deprecation policy and sunset date after required deprecation period is not breaking](diff/deprecation_test.go?plain=1#L131)  
[deprecating an endpoint without a deprecation policy and without specifying sunset date is not breaking](diff/deprecation_test.go?plain=1#L88)  
