...
[adding a pattern to a schema is breaking for recursive properties](checker/checker_breaking_test.go?plain=1#L429)  
[adding a pattern to a schema is breaking](checker/checker_breaking_test.go?plain=1#L395)  
[adding a pattern to a schema is breaking](checker/checker_breaking_test.go?plain=1#L411)  
...
[deleting a media-type from response is breaking](checker/checker_breaking_test.go?plain=1#L365)  
...
[modifying a pattern in a schema is breaking](checker/checker_breaking_test.go?plain=1#L445)  
[modifying a pattern in request parameter is breaking](checker/checker_breaking_test.go?plain=1#L461)  
[modifying the default value of an optional request parameter is breaking](checker/checker_breaking_test.go?plain=1#L491)  
...
[removing an existing optional response header is breaking as warn](checker/checker_breaking_test.go?plain=1#L346)  
...
[removing/updating a tag is breaking (optional)](checker/checker_breaking_test.go?plain=1#L296)  
...
[deleting a pattern from a schema is not breaking](checker/checker_breaking_test.go?plain=1#L381)  
...
[modifying a pattern to ".*"" in a schema is not breaking](checker/checker_breaking_test.go?plain=1#L477)  
[modifying the default value of a required request parameter is not breaking](checker/checker_breaking_test.go?plain=1#L507)  
...
[removing an existing response with error status is not breaking](checker/checker_breaking_test.go?plain=1#L330)  
[removing an existing response with unparseable status is not breaking](checker/checker_breaking_test.go?plain=1#L314)  
