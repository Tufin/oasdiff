...
[modifying the default value of an optional request parameter is breaking](checker/checker_breaking_test.go?plain=1#L435)  
...
[modifying the default value of a required request parameter is not breaking](checker/checker_breaking_test.go?plain=1#L451)  
...
[removing an existing response with error status is not breaking](checker/checker_breaking_test.go?plain=1#L274)  
[removing an existing response with unparseable status is not breaking](checker/checker_breaking_test.go?plain=1#L258)  
