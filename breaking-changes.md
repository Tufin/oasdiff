...
[deleting an operation before sunset is breaking](diff/deprecation_test.go?plain=1#L19)  
[deleting an operation is breaking](diff/breaking_test.go?plain=1#L17)  
[deleting an operation without sunset is breaking](diff/deprecation_test.go?plain=1#L36)  
...
[deleting a path after sunset of all contained operations is not breaking](diff/deprecation_test.go?plain=1#L151)  
...
[deleting an operation after sunset is not breaking](diff/deprecation_test.go?plain=1#L53)  
