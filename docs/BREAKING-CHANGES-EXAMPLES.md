...
[changing a response property to optional under AllOf, AnyOf or OneOf is breaking](../checker/check_breaking_property_test.go?plain=1#L664)  
...
[changing an existing property in request body anyOf to required is breaking](../checker/check_breaking_property_test.go?plain=1#L630)  
[changing an existing property in request body items to required is breaking](../checker/check_breaking_property_test.go?plain=1#L598)  
...
[changing an existing property under another property in request body to required is breaking](../checker/check_breaking_property_test.go?plain=1#L647)  
...
[changing an existing property in request body items to required with a default value is not breaking](../checker/check_breaking_property_test.go?plain=1#L616)  
