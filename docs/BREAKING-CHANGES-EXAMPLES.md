...
[deleting a parameter after sunset date is not breaking](../checker/check_parameter_deprecation_test.go?plain=1#L16)  
...
[parameters that became deprecated](../checker/check_parameter_deprecation_test.go?plain=1#L253)  
[parameters that were re-activated](../checker/check_parameter_deprecation_test.go?plain=1#L276)  
