...
[changing sunset from an invalid date for a deprecated endpoint is breaking](../checker/check_deprecation_test.go?plain=1#L422)  
[changing sunset to an earlier date for a deprecated endpoint is breaking](../checker/check_deprecation_test.go?plain=1#L386)  
[changing sunset to an invalid date for a deprecated endpoint is breaking](../checker/check_deprecation_test.go?plain=1#L404)  
...
[deleting a path with some operations having sunset date in the future is breaking](../checker/check_deprecation_test.go?plain=1#L350)  
...
[deleting sunset header for a deprecated endpoint is breaking](../checker/check_deprecation_test.go?plain=1#L368)  
[deprecating an operation with a deprecation policy and an invalid stability level is breaking](../checker/check_deprecation_test.go?plain=1#L121)  
[deprecating an operation with a deprecation policy and an invalid sunset date is breaking](../checker/check_deprecation_test.go?plain=1#L101)  
[deprecating an operation with a deprecation policy and sunset date before required deprecation period is breaking](../checker/check_deprecation_test.go?plain=1#L292)  
...
[removing the path without a deprecation policy and without specifying sunset date is breaking if some APIs are not alpha stability level](../checker/check_deprecation_test.go?plain=1#L207)  
[removing the path without a deprecation policy and without specifying sunset date is breaking if some APIs are not draft stability level](../checker/check_deprecation_test.go?plain=1#L263)  
...
[specifying an invalid stability level is breaking](../checker/check_deprecation_test.go?plain=1#L173)  
...
[deleting a path after sunset date of all contained operations is not breaking](../checker/check_deprecation_test.go?plain=1#L335)  
...
[deleting other extension (not sunset) header for a deprecated endpoint is not breaking](../checker/check_deprecation_test.go?plain=1#L440)  
...
[deprecating an operation with a deprecation policy and sunset date after required deprecation period is not breaking](../checker/check_deprecation_test.go?plain=1#L313)  
[deprecating an operation without a deprecation policy and without specifying sunset date is not breaking for draft level](../checker/check_deprecation_test.go?plain=1#L227)  
[deprecating an operation without a deprecation policy and without specifying sunset date is not breaking](../checker/check_deprecation_test.go?plain=1#L158)  
[deprecating an operation without a deprecation policy but without specifying sunset date is not breaking](../checker/check_deprecation_test.go?plain=1#L141)  
...
[no change to headers for a deprecated endpoint is not breaking](../checker/check_deprecation_test.go?plain=1#L455)  
...
[removing the path without a deprecation policy and without specifying sunset date is not breaking for alpha level](../checker/check_deprecation_test.go?plain=1#L188)  
[removing the path without a deprecation policy and without specifying sunset date is not breaking for draft level](../checker/check_deprecation_test.go?plain=1#L244)  
...
[path operations that became deprecated](../checker/check_deprecation_test.go?plain=1#L488)  
[path operations that were re-activated](../checker/check_deprecation_test.go?plain=1#L511)  
