...
[deprecating a parameter with a deprecation policy and an invalid sunset date is breaking](../checker/check_request_parameter_deprecation_test.go?plain=1#L16)  
...
[parameters that became deprecated](../checker/check_request_parameter_deprecation_test.go?plain=1#L165)  
[parameters that were re-activated](../checker/check_request_parameter_deprecation_test.go?plain=1#L188)  
[path operations that became deprecated](../checker/check_api_deprecation_test.go?plain=1#L202)  
[path operations that were re-activated](../checker/check_api_deprecation_test.go?plain=1#L225)  
