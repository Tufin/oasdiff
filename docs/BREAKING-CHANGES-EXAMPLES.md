...
[changing sunset from an invalid date for a deprecated endpoint is breaking](../checker/check_deprecation_test.go?plain=1#L434)  
[changing sunset to an earlier date for a deprecated endpoint is breaking](../checker/check_deprecation_test.go?plain=1#L398)  
[changing sunset to an invalid date for a deprecated endpoint is breaking](../checker/check_deprecation_test.go?plain=1#L416)  
...
[deleting a path with some operations having sunset date in the future is breaking](../checker/check_deprecation_test.go?plain=1#L362)  
...
[deleting sunset header for a deprecated endpoint is breaking](../checker/check_deprecation_test.go?plain=1#L380)  
[deprecating an operation with a deprecation policy and an invalid stability level is breaking](../checker/check_deprecation_test.go?plain=1#L119)  
[deprecating an operation with a deprecation policy and an invalid sunset date is breaking](../checker/check_deprecation_test.go?plain=1#L100)  
[deprecating an operation with a deprecation policy and sunset date before required deprecation period is breaking](../checker/check_deprecation_test.go?plain=1#L306)  
[deprecating an operation with a deprecation policy but without specifying sunset date is breaking](../checker/check_deprecation_test.go?plain=1#L81)  
...
[modifying a pattern in request parameter is breaking](../checker/check_breaking_test.go?plain=1#L524)  
[modifying the default value of an optional request parameter is breaking](../checker/check_breaking_test.go?plain=1#L555)  
...
[removing 'allOf' subschema from the request body or request body property is breaking with warn](../checker/check_breaking_test.go?plain=1#L734)  
[removing 'anyOf' schema from the request body or request body property is breaking](../checker/check_breaking_test.go?plain=1#L669)  
[removing 'oneOf' schema from the request body or request body property is breaking](../checker/check_breaking_test.go?plain=1#L691)  
[removing a media type from request body is breaking](../checker/check_breaking_test.go?plain=1#L653)  
...
[removing an schema object from components is breaking (optional)](../checker/check_breaking_test.go?plain=1#L628)  
[removing the default value of an optional request parameter is breaking](../checker/check_breaking_test.go?plain=1#L591)  
[removing the path without a deprecation policy and without specifying sunset date is breaking if some APIs are not alpha stability level](../checker/check_deprecation_test.go?plain=1#L221)  
[removing the path without a deprecation policy and without specifying sunset date is breaking if some APIs are not draft stability level](../checker/check_deprecation_test.go?plain=1#L277)  
...
[specifying an invalid stability level is breaking](../checker/check_deprecation_test.go?plain=1#L187)  
...
[deleting a path after sunset date of all contained operations is not breaking](../checker/check_deprecation_test.go?plain=1#L347)  
...
[deleting an operation after sunset date is not breaking](../checker/check_deprecation_test.go?plain=1#L66)  
[deleting an operation without sunset date is not breaking](../checker/check_deprecation_test.go?plain=1#L51)  
[deleting other extension (not sunset) header for a deprecated endpoint is not breaking](../checker/check_deprecation_test.go?plain=1#L452)  
...
[deprecating an operation with a deprecation policy and sunset date after required deprecation period is not breaking](../checker/check_deprecation_test.go?plain=1#L326)  
[deprecating an operation without a deprecation policy and without specifying sunset date is not breaking for alpha level](../checker/check_deprecation_test.go?plain=1#L172)  
[deprecating an operation without a deprecation policy and without specifying sunset date is not breaking for draft level](../checker/check_deprecation_test.go?plain=1#L241)  
[deprecating an operation without a deprecation policy but without specifying sunset date is not breaking](../checker/check_deprecation_test.go?plain=1#L138)  
...
[modifying a pattern to ".*" in a schema is not breaking](../checker/check_breaking_test.go?plain=1#L541)  
[modifying the default value of a required request parameter is not breaking](../checker/check_breaking_test.go?plain=1#L609)  
...
[no change to headers for a deprecated endpoint is not breaking](../checker/check_deprecation_test.go?plain=1#L467)  
...
[removing the path without a deprecation policy and without specifying sunset date is not breaking for alpha level](../checker/check_deprecation_test.go?plain=1#L202)  
[removing the path without a deprecation policy and without specifying sunset date is not breaking for draft level](../checker/check_deprecation_test.go?plain=1#L258)  
...
[path operations that became deprecated](../checker/check_deprecation_test.go?plain=1#L500)  
[path operations that were re-activated](../checker/check_deprecation_test.go?plain=1#L523)  
