...
[changing sunset from an invalid date for a deprecated endpoint is breaking](../checker/check_deprecation_test.go?plain=1#L430)  
[changing sunset to an earlier date for a deprecated endpoint is breaking](../checker/check_deprecation_test.go?plain=1#L394)  
[changing sunset to an invalid date for a deprecated endpoint is breaking](../checker/check_deprecation_test.go?plain=1#L412)  
...
[deleting a path with some operations having sunset date in the future is breaking](../checker/check_deprecation_test.go?plain=1#L358)  
...
[deleting an operation before sunset date is breaking](../checker/check_deprecation_test.go?plain=1#L29)  
[deleting an operation is breaking](../checker/check_breaking_test.go?plain=1#L45)  
[deleting sunset header for a deprecated endpoint is breaking](../checker/check_deprecation_test.go?plain=1#L376)  
[deprecating an operation with a deprecation policy and an invalid stability level is breaking](../checker/check_deprecation_test.go?plain=1#L115)  
[deprecating an operation with a deprecation policy and an invalid sunset date is breaking](../checker/check_deprecation_test.go?plain=1#L96)  
[deprecating an operation with a deprecation policy and sunset date before required deprecation period is breaking](../checker/check_deprecation_test.go?plain=1#L302)  
[deprecating an operation with a deprecation policy but without specifying sunset date is breaking](../checker/check_deprecation_test.go?plain=1#L77)  
...
[removing the path without a deprecation policy and without specifying sunset date is breaking if some APIs are not alpha stability level](../checker/check_deprecation_test.go?plain=1#L217)  
[removing the path without a deprecation policy and without specifying sunset date is breaking if some APIs are not draft stability level](../checker/check_deprecation_test.go?plain=1#L273)  
...
[specifying an invalid stability level is breaking](../checker/check_deprecation_test.go?plain=1#L183)  
...
[deleting a path after sunset date of all contained operations is not breaking](../checker/check_deprecation_test.go?plain=1#L343)  
...
[deleting an operation after sunset date is not breaking](../checker/check_deprecation_test.go?plain=1#L62)  
[deleting an operation without sunset date is not breaking](../checker/check_deprecation_test.go?plain=1#L47)  
[deleting other extension (not sunset) header for a deprecated endpoint is not breaking](../checker/check_deprecation_test.go?plain=1#L448)  
...
[deprecating an operation with a deprecation policy and sunset date after required deprecation period is not breaking](../checker/check_deprecation_test.go?plain=1#L322)  
[deprecating an operation without a deprecation policy and without specifying sunset date is not breaking for alpha level](../checker/check_deprecation_test.go?plain=1#L168)  
[deprecating an operation without a deprecation policy and without specifying sunset date is not breaking for draft level](../checker/check_deprecation_test.go?plain=1#L237)  
[deprecating an operation without a deprecation policy but without specifying sunset date is not breaking](../checker/check_deprecation_test.go?plain=1#L134)  
...
[no change to headers for a deprecated endpoint is not breaking](../checker/check_deprecation_test.go?plain=1#L463)  
...
[removing the path without a deprecation policy and without specifying sunset date is not breaking for alpha level](../checker/check_deprecation_test.go?plain=1#L198)  
[removing the path without a deprecation policy and without specifying sunset date is not breaking for draft level](../checker/check_deprecation_test.go?plain=1#L254)  
...
[path operations that became deprecated](../checker/check_deprecation_test.go?plain=1#L496)  
[path operations that were re-activated](../checker/check_deprecation_test.go?plain=1#L519)  
