...
[adding a required request body is breaking](../checker/check_breaking_test.go?plain=1#L62)  
...
[changing an existing property under another property in request body to required is breaking](../checker/check_breaking_property_test.go?plain=1#L628)  
...
[changing an existing response header from required to optional is breaking](../checker/check_breaking_test.go?plain=1#L215)  
...
[deleting a path is breaking](../checker/check_breaking_test.go?plain=1#L38)  
[deleting a path with some operations having sunset date in the future is breaking](../checker/check_deprecation_test.go?plain=1#L281)  
...
[deleting an enum value is breaking](../checker/check_breaking_test.go?plain=1#L102)  
[deleting an operation before sunset date is breaking](../checker/check_deprecation_test.go?plain=1#L33)  
[deleting an operation is breaking](../checker/check_breaking_test.go?plain=1#L46)  
[deleting an operation without sunset date is breaking](../checker/check_deprecation_test.go?plain=1#L51)  
[deleting sunset header for a deprecated endpoint is breaking](../checker/check_deprecation_test.go?plain=1#L299)  
[deprecating an operation with a deprecation policy and sunset date before required deprecation period is breaking](../checker/check_deprecation_test.go?plain=1#L223)  
[deprecating an operation with a deprecation policy but without specifying sunset date is breaking](../checker/check_deprecation_test.go?plain=1#L84)  
...
[new required header param is breaking](../checker/check_breaking_test.go?plain=1#L174)  
[new required path param is breaking](../checker/check_breaking_test.go?plain=1#L157)  
...
[removing an existing required response header is breaking as error](../checker/check_breaking_test.go?plain=1#L232)  
[removing an existing response with non-successful status is breaking (optional)](../checker/check_breaking_test.go?plain=1#L271)  
[removing an existing response with successful status is breaking](../checker/check_breaking_test.go?plain=1#L252)  
...
[removing the path without a deprecation policy and without specifying sunset date is breaking if some APIs are not alpha stability level](../checker/check_deprecation_test.go?plain=1#L138)  
[removing the path without a deprecation policy and without specifying sunset date is breaking if some APIs are not draft stability level](../checker/check_deprecation_test.go?plain=1#L194)  
[removing/updating a property enum in response is breaking (optional)](../checker/check_breaking_test.go?plain=1#L334)  
[removing/updating a tag is breaking (optional)](../checker/check_breaking_test.go?plain=1#L352)  
[removing/updating an enum in request body is breaking (optional)](../checker/check_breaking_test.go?plain=1#L311)  
[removing/updating an operation id is breaking (optional)](../checker/check_breaking_test.go?plain=1#L290)  
[setting the default value of an optional request parameter is breaking](../checker/check_breaking_test.go?plain=1#L574)  

## Examples of non-breaking changes
[adding a media-type to response is not breaking](../checker/check_not_breaking_test.go?plain=1#L185)  
...
[adding a required property to response is not breaking](../checker/check_not_breaking_test.go?plain=1#L290)  
[adding a tag is not breaking](../checker/check_not_breaking_test.go?plain=1#L267)  
[adding an enum value is not breaking](../checker/check_not_breaking_test.go?plain=1#L83)  
[adding an enum value to request body is not breaking](../checker/check_breaking_property_test.go?plain=1#L139)  
[adding an operation ID is not breaking](../checker/check_not_breaking_test.go?plain=1#L278)  
...
[changing a link to operation ID is not breaking](../checker/check_not_breaking_test.go?plain=1#L176)  
...
[changing comments is not breaking](../checker/check_not_breaking_test.go?plain=1#L107)  
[changing extensions is not breaking](../checker/check_not_breaking_test.go?plain=1#L95)  
...
[changing operation ID is not breaking](../checker/check_not_breaking_test.go?plain=1#L167)  
...
[changing servers is not breaking](../checker/check_not_breaking_test.go?plain=1#L253)  
[deleting a path after sunset date of all contained operations is not breaking](../checker/check_deprecation_test.go?plain=1#L266)  
...
[deleting an operation after sunset date is not breaking](../checker/check_deprecation_test.go?plain=1#L69)  
[deprecating a header is not breaking](../checker/check_not_breaking_test.go?plain=1#L227)  
[deprecating a parameter is not breaking](../checker/check_not_breaking_test.go?plain=1#L214)  
[deprecating a schema is not breaking](../checker/check_not_breaking_test.go?plain=1#L240)  
[deprecating an operation with a deprecation policy and sunset date after required deprecation period is not breaking](../checker/check_deprecation_test.go?plain=1#L244)  
[deprecating an operation without a deprecation policy and without specifying sunset date is not breaking for draft level](../checker/check_deprecation_test.go?plain=1#L158)  
[deprecating an operation without a deprecation policy and without specifying sunset date is not breaking](../checker/check_deprecation_test.go?plain=1#L104)  
...
[new optional header param is not breaking](../checker/check_not_breaking_test.go?plain=1#L119)  
[new optional property in request header is not breaking](../checker/check_breaking_property_test.go?plain=1#L39)  
[new required response header param is not breaking](../checker/check_not_breaking_test.go?plain=1#L153)  
...
[removing the path without a deprecation policy and without specifying sunset date is not breaking for alpha level](../checker/check_deprecation_test.go?plain=1#L119)  
[removing the path without a deprecation policy and without specifying sunset date is not breaking for draft level](../checker/check_deprecation_test.go?plain=1#L175)  
[renaming a path parameter is not breaking](../checker/check_breaking_test.go?plain=1#L137)  
...
[adding pattern to request parameters](../checker/check_request_parameter_pattern_added_or_changed_test.go?plain=1#L36)  
...
[changing an existing header param to optional](../checker/check_not_breaking_test.go?plain=1#L133)  
...
[deprecating an operation with sunset greater than min](../checker/check_not_breaking_test.go?plain=1#L199)  
...
[path operations that were re-activated](../checker/check_deprecation_test.go?plain=1#L358)  
...
[removing pattern from request parameters](../checker/check_request_parameter_pattern_added_or_changed_test.go?plain=1#L59)  
