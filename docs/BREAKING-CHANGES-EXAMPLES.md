...
[deleting a path with some operations having sunset date in the future is breaking](../checker/check_deprecation_test.go?plain=1#L330)  
...
[deleting sunset header for a deprecated endpoint is breaking](../checker/check_deprecation_test.go?plain=1#L348)  
...
[deprecating an operation with a deprecation policy and sunset date before required deprecation period is breaking](../checker/check_deprecation_test.go?plain=1#L272)  
...
[removing the path without a deprecation policy and without specifying sunset date is breaking if some APIs are not alpha stability level](../checker/check_deprecation_test.go?plain=1#L187)  
[removing the path without a deprecation policy and without specifying sunset date is breaking if some APIs are not draft stability level](../checker/check_deprecation_test.go?plain=1#L243)  
...
[specifying an invalid stability level is breaking](../checker/check_deprecation_test.go?plain=1#L153)  
...
[deleting a path after sunset date of all contained operations is not breaking](../checker/check_deprecation_test.go?plain=1#L315)  
...
[deprecating an operation with a deprecation policy and sunset date after required deprecation period is not breaking](../checker/check_deprecation_test.go?plain=1#L293)  
[deprecating an operation without a deprecation policy and without specifying sunset date is not breaking for draft level](../checker/check_deprecation_test.go?plain=1#L207)  
[deprecating an operation without a deprecation policy and without specifying sunset date is not breaking](../checker/check_deprecation_test.go?plain=1#L138)  
[deprecating an operation without a deprecation policy but without specifying sunset date is not breaking](../checker/check_deprecation_test.go?plain=1#L121)  
...
[removing the path without a deprecation policy and without specifying sunset date is not breaking for alpha level](../checker/check_deprecation_test.go?plain=1#L168)  
[removing the path without a deprecation policy and without specifying sunset date is not breaking for draft level](../checker/check_deprecation_test.go?plain=1#L224)  
...
[path operations that became deprecated](../checker/check_deprecation_test.go?plain=1#L384)  
[path operations that were re-activated](../checker/check_deprecation_test.go?plain=1#L407)  
